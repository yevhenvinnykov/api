...
class ArticlesController {
    ...
    static async getArticles(req, res) {
        try {
            const action = req.route.path === '/api/articles' ? 'getArticles' : 'getArticlesFromFollowedUsers';
            const { articles, articlesCount } = await ArticlesService[action](req.userId, req.query);
